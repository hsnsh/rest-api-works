...
namespace HsNsH.ApiWorks.DataApi.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        private async Task<User> GetUserFromAccessToken(string accessToken)
        {
            try
            {
                ...
                var tokenValidationParameters = new TokenValidationParameters { ValidateIssuerSigningKey = true, IssuerSigningKey = new SymmetricSecurityKey(key), ValidateIssuer = false, ValidateAudience = false };
